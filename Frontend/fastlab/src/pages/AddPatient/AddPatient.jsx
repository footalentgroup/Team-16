...
const AddPatient = () => {
  ...
  const onSubmit = (data) => {
    ...
    navigate("/admin/pedidos/add-analisis");
  };

  return (
    <>
  
      <h1 className="text-2xl font-bold text-[#0E1B27] px-8 py-8 mt-12 ">Añadir paciente</h1>
      <section className="flex w-full justify-center min-h-screen bg-gray-50">
        <ToastContainer />
